...
Uso:
    ...
    python data-ingestion/run_all.py icmbio funai inpe    # fontes específicas
"""
import sys
...
SOURCES = {
    "icmbio": ("sources.icmbio", "ICMBio - Unidades de Conservação"),
    "funai": ("sources.funai", "FUNAI - Terras Indígenas"),
