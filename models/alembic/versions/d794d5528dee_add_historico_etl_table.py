"""add_historico_etl_table

Revision ID: d794d5528dee
Revises: e8f9a0b1c2d3
Create Date: 2026-05-25 19:41:22.117056
...
def upgrade() -> None:
    """Upgrade schema."""
    # Cria apenas a sua tabela necessária, ignorando as tabelas nativas do PostGIS
    op.create_table('historico_etl',
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('pipeline_name', sa.TEXT(), nullable=False),
    sa.Column('etapa', sa.TEXT(), nullable=False),
    sa.Column('status', sa.TEXT(), nullable=False),
    sa.Column('detalhes', sa.TEXT(), nullable=True),
    sa.Column('data_inicio', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    ...
    sa.Column('erro_traceback', sa.TEXT(), nullable=True),
